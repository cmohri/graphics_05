...
edges = []
fname = "image.ppm"
#add_box(edges, 100, 300, 0, 200, 200, 200)
#print_matrix(edges)
'''
add_sphere(edges, 200, 200, 10, 100, 20)
print_matrix(edges)
#matrix_mult(make_rotY(30), edges)
#matrix_mult(make_rotX(30), edges)
matrix_mult(make_rotX(50), edges)
matrix_mult(make_rotY(100), edges)
matrix_mult(make_rotZ(100), edges)
draw_lines(edges, s, [255, 0, 0])
print_matrix(make_rotZ(1))
matrix_mult(make_rotZ(1), edges)
print_matrix(edges)



add_torus(edges, 200, 200, 50, 20, 19, 10)
print_matrix(edges)
matrix_mult(make_rotX(100), edges)
matrix_mult(make_rotZ(150), edges)
matrix_mult(make_translate(0, 100, 0), edges)
matrix_mult(make_rotY(150), edges)
draw_lines(edges, s, [255, 0, 0])
